...
TEST_CASE("Empty & Negative Withdraw") {
  Atm atm;
  REQUIRE_THROWS_AS(atm.WithdrawCash(213131, 2323, 30), std::invalid_argument);

  atm.RegisterAccount(12345678, 1234, "Sam Sepiol", 300.30);
  REQUIRE_THROWS_AS(atm.WithdrawCash(12345678, 1234, -30), std::invalid_argument);
